...
<Tabs>
  <TabItem label="Class-based rules">
    ...
    Import the rule class and pass an instance to your rules array. This approach supports constructor options such as `strict` mode and per-reason error messages.
