...
- Browse the [PESEL](/identifiers/pesel/), [NIP](/identifiers/nip/), [REGON](/identifiers/regon/), [KRS](/identifiers/krs/), or [NRB](/identifiers/nrb/) reference for full method listings.
