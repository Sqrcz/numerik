...
4. Przestaw kolejność: cyfry 3–26 (BBAN) + `2521` (kodowanie numeryczne `PL`) + cyfry 1–2 (cyfry kontrolne).
5. Oblicz resztę z dzielenia uformowanej liczby przez 97. Wynik musi wynosić `1`.

---

## VAT-EU

Walidacja VAT-EU to cienka warstwa nad NIP:
...
Walidacja IBAN to cienka warstwa nad NRB:

1. Usuń spacje i myślniki. Odrzuć wejścia dłuższe niż 40 znaków.
2. Wymagaj, aby pierwsze dwa znaki to `PL` (bez rozróżniania wielkości liter) — inaczej błąd `InvalidFormat`.
3. Usuń prefiks. Wymagaj dokładnie 26 cyfr.
