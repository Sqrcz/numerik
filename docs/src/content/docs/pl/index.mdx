...
template: splash
hero:
  tagline: Walidacja i parsowanie polskich numerów identyfikacyjnych (PESEL, NIP, REGON, KRS). Zwraca czytelne obiekty danych i precyzyjnie wskazuje przyczyny błędów.
  actions:
    - text: Pierwsze kroki
