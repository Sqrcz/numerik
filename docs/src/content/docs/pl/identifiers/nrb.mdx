...
$nrb = Numerik::nrb()->tryParse('błędny-wejście'); // null
```
...
4. Zweryfikuj sumę kontrolną MOD-97:
   ...
   - Oblicz resztę z dzielenia przez 97 tak uformowanej liczby.
...
|-----------|---------|-------|
| `InvalidLength` | `invalid_length` | Po normalizacji nie ma dokładnie 26 cyfr lub surowe wejście przekracza 40 znaków. |
