---
title: Numerik
description: Modern PHP 8.2+ library for validating and parsing Polish identification numbers — PESEL, NIP, REGON, and KRS.
template: splash
hero:
...
- **Zero production dependencies** — `require` only `php: ^8.2`.
