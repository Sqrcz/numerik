---
title: Numerik
description: Modern PHP 8.3+ library for validating and parsing Polish identification numbers — PESEL, NIP, REGON, KRS, and NRB.
template: splash
hero:
...
<CardGrid stagger>
  ...
  <Card title="Laravel" icon="puzzle">
    Drop-in Laravel validation rules for all five identifiers via `slashlab/numerik-laravel`. Supports class-based and string-based syntax, with strict-mode control for PESEL.
  </Card>
</CardGrid>
